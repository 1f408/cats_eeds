...
import (
	...
	east "github.com/1f408/cats_eeds/md2html/dt_table/ast"
)
...
func TestTableWithAlignDefault(t *testing.T) {
	markdown := goldmark.New(
		...
		goldmark.WithExtensions(
			dt_table.NewTable(
				dt_table.WithTableCellAlignMethod(dt_table.TableCellAlignDefault),
			),
		),
	)
	testutil.DoTestCase(
...
func TestTableWithAlignAttribute(t *testing.T) {
	markdown := goldmark.New(
		...
		goldmark.WithExtensions(
			dt_table.NewTable(
				dt_table.WithTableCellAlignMethod(dt_table.TableCellAlignAttribute),
			),
		),
	)
	testutil.DoTestCase(
...
func TestTableWithAlignStyle(t *testing.T) {
	markdown := goldmark.New(
		...
		goldmark.WithExtensions(
			dt_table.NewTable(
				dt_table.WithTableCellAlignMethod(dt_table.TableCellAlignStyle),
			),
		),
	)
	testutil.DoTestCase(
...
func TestTableWithAlignNone(t *testing.T) {
	markdown := goldmark.New(
		...
		goldmark.WithExtensions(
			dt_table.NewTable(
				dt_table.WithTableCellAlignMethod(dt_table.TableCellAlignNone),
			),
		),
	)
	testutil.DoTestCase(
