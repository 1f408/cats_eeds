...
func GetFootnoteIndex(node gast.Node) (int, bool) {
	switch n := node.(type) {
	default:
	case *FootnoteLink:
		return n.Index, true
...
func GetFootnoteRefIndex(node gast.Node) (int, bool) {
	switch n := node.(type) {
	default:
	case *FootnoteLink:
		return n.RefIndex, true
	case *FootnoteBacklink:
		return n.RefIndex, true
	}
	return -1, false
...
func GetFootnoteRefCount(node gast.Node) (int, bool) {
	switch n := node.(type) {
	default:
	case *FootnoteLink:
		return n.RefCount, true
	case *FootnoteBacklink:
		return n.RefCount, true
	}
	return -1, false
